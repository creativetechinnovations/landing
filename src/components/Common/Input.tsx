    ...
    <div className="relative flex flex-col w-full box-content">
      ...
      <input
        className={classnames(
          'h-13.5 py-1.5 pr-5 pl-7.5 text-3.5 text-gray-100  w-full placeholder-gray-100 transition-all duration-75 bg-white border-2 border-gray-50 focus:border-blue-100',
          className
        )}
        name={name}
